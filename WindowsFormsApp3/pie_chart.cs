...
namespace WindowsFormsApp3
{
    ...
    public partial class pie_chart : Form
    {
        ...
        public pie_chart(string username)
        {
        ...
        pie_chart_class piechart = new pie_chart_class();
